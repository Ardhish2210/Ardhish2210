# 💫 About Me:
👨‍💻 About Me<br>Hi! I’m Ardhish Patel, a third-year B.Tech student in Electronics and Communication Engineering at the Indian Institute of Information Technology (IIIT) Nagpur.<br>💡 I have a strong interest in VLSI design, especially the complete RTL to GDSII flow, from digital logic to physical layout.<br>🔧 I work on hands-on projects involving SystemVerilog, FPGA-based implementation, and ASIC design methodologies.<br>🧪 I explore hardware verification using UVM, and enjoy optimizing designs for better performance and area efficiency.<br>📘 I’m continuously learning about EDA tools, timing closure, floorplanning, and low-power design techniques to deepen my understanding of the chip design pipeline.
